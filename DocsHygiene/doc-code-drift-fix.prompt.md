...
The audit writes to `docs/audits/doc-code-drift-<timestamp>.md` when
the project has a `docs/` directory, and inline otherwise. Look for
files matching `docs/audits/doc-code-drift-*.md` and pick the most
recent (`ls -1 docs/audits/doc-code-drift-*.md 2>/dev/null | sort | tail -1`

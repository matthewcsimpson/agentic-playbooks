...
The audit writes to `docs/audits/dependencies-<timestamp>.md`. Look
for files matching `docs/audits/dependencies-*.md` and pick the
most recent (`ls -1 docs/audits/dependencies-*.md 2>/dev/null | sort | tail -1`

...
The deliverable is `<root>/audits/dependencies-<timestamp>.md`
(see Step 7). Do not modify any manifest, lockfile, or installed
dep — investigate and report only.
...
Write to `<root>/audits/dependencies-<timestamp>.md`, where:

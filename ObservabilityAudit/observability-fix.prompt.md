...
The audit writes to `docs/audits/observability-<timestamp>.md`. Look
for files matching `docs/audits/observability-*.md` and pick the
most recent (`ls -1 docs/audits/observability-*.md 2>/dev/null | sort | tail -1`
